...
module.exports = 
{
	...
	{
		//Get id
		const peerId = request.resourceURL.query.peerId;
...
class Client
{
	...
	start(offer)
	{
		...
		this.transponder = this.outgoingStream.attachTo(incomingStream);
	...
	{
		this.transponder.selectLayer(parseInt(spatialLayerId),parseInt(temporalLayerId));
	}
...
const httpserver = http.createServer ((req, res) => {
	...
	//get peer id
	const peerId = parseInt(parsedUrl.searchParams.get("peer_id"));
